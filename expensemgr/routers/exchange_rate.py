...
def get_exchange_rate_multiplier(db: db_dependency, user: user_dependency, redis: redis_dependency, user_curr_code: str, db_curr_code: str):
    exchange_rate = ExchangeRateService(db=db, user=user, redis=redis).get_exchange_rate_multiplier(user_curr_code=user_curr_code, db_curr_code = db_curr_code)
