...
class ExchangeRateService:
    ...
    def __init__(self, db: db_dependency, user: user_dependency, redis: redis_dependency):
        self.db = db
        self.user = user
        self.redis = redis

    @expense_mgr_logger.wrapper_logger(log_args=True)
    def get_exchange_rate_multiplier(self, user_curr_code: str, db_curr_code: str) -> ExchangeRateOut:
