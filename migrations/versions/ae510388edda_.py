...
Revision ID: ae510388edda
Revises: 
Create Date: 2026-06-23 10:18:48.624938
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_money_schema_division_by_division_by_key'), 'division_by', ['division_by_key'], unique=False, schema='money_schema')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_money_schema_division_by_division_by_key'), table_name='division_by', schema='money_schema')
