...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_money_schema_division_by_division_by_key"),
        "division_by",
        ["division_by_key"],
        unique=False,
        schema="money_schema",
    ...
    op.create_table(
        ...
        sa.Column(
            "user_active_ind", sa.Boolean(), server_default="TRUE", nullable=True
        ),
        sa.PrimaryKeyConstraint("user_key", name="user_pk"),
        schema="user_schema",
    )
    op.create_index(
        op.f("ix_user_schema_user_email"),
        "user",
        ["email"],
        unique=True,
        schema="user_schema",
    ...
    op.create_index(
        op.f("ix_user_schema_user_user_key"),
        "user",
        ["user_key"],
        unique=False,
        schema="user_schema",
    ...
    op.create_index(
        op.f("ix_user_schema_user_username"),
        "user",
        ["username"],
        unique=True,
        schema="user_schema",
    ...
    op.create_index(
        op.f("ix_money_schema_currency_currency_code"),
        "currency",
        ["currency_code"],
        unique=True,
        schema="money_schema",
    ...
    op.create_index(
        op.f("ix_money_schema_currency_currency_key"),
        "currency",
        ["currency_key"],
        unique=False,
        schema="money_schema",
    ...
    op.create_index(
        op.f("ix_money_schema_expense_expense_key"),
        "expense",
        ["expense_key"],
        unique=False,
        schema="money_schema",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_user_schema_user_username"), table_name="user", schema="user_schema"
    )
    op.drop_index(
        op.f("ix_user_schema_user_user_key"), table_name="user", schema="user_schema"
    )
    op.drop_index(
        op.f("ix_user_schema_user_email"), table_name="user", schema="user_schema"
    )
    op.drop_table("user", schema="user_schema")
    op.drop_index(
        op.f("ix_money_schema_division_by_division_by_key"),
        table_name="division_by",
        schema="money_schema",
    )
